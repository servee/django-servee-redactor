	...
	Redactor.fn = $.Redactor.prototype = {
		...
		videoInsert: function ()
		{
			...
			// parse if it is link on youtube & vimeo
				var iframeStart = '<div class="embed-container" style="position: relative; padding-bottom: 56.25%; padding-top:0px; height: 0; overflow: hidden; max-width: 100%; height: auto;"><iframe width="100%" height="100%" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;" src="',
